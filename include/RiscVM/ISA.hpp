...
namespace RiscVM
{
    ...
    enum RV32IM
    {
        ...
        RV32IM_FENCEI = 0b001 << 7 | RV32_64G_MISC_MEM,

        RV32IM_CSRRW = 0b001 << 7 | RV32_64G_SYSTEM,
        RV32IM_CSRRS = 0b010 << 7 | RV32_64G_SYSTEM,
        RV32IM_CSRRC = 0b011 << 7 | RV32_64G_SYSTEM,
        RV32IM_CSRRWI = 0b101 << 7 | RV32_64G_SYSTEM,
        RV32IM_CSRRSI = 0b110 << 7 | RV32_64G_SYSTEM,
        RV32IM_CSRRCI = 0b111 << 7 | RV32_64G_SYSTEM,
